...
function setup() {
 ...
 // ground = new Ground();
  ...
  polygon = Bodies.circle(220,350,20);
  this.polygon.restitution = 0.3;
  this.polygon.friction = 0.0015;
...
function draw() {
  ...
  textSize(30);
  stroke(5);
  text("Drag the stone and release it to destroy the blocks",290,30);
